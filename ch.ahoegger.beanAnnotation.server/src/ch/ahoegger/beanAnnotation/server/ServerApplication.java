 ...
 * org.eclipse.equinox.http.jetty.context.path=/beanAnnotation
 ...
 * eclipse.product=ch.ahoegger.beanAnnotation.server.product
 */
public class ServerApplication implements IApplication {
  ...
  public Object start(IApplicationContext context) throws Exception {
    ...
    */
    logger.info("beanAnnotation server initialized");
    return EXIT_OK;
  }
